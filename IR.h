...
struct InterCode_
{
	enum {ASSIGN, STAR_ASSIGN_STAR, STAR_ASSIGN_, _ASSIGN_AND, _ASSIGN_STAR, ADD, SUB, MUL, DIVIDE, LABEL, IFGOTO, GOTO, READ, WRITE, CALL, ARG, RET, FUNCDEC, PARAM, DEC} kind;
	union
	{
